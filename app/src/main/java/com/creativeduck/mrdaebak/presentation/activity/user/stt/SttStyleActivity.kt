...
import com.creativeduck.mrdaebak.presentation.activity.user.OrderActivity
import com.creativeduck.mrdaebak.presentation.activity.user.StyleActivity
import com.creativeduck.mrdaebak.presentation.activity.user.StyleActivity.Companion.DELUXE
...
class SttStyleActivity : BaseActivity<ActivitySttStyleBinding>(ActivitySttStyleBinding::inflate) {
            ...
            for(btn in btnList) {
                ...
                if (btn.isPressed) {
                    CoroutineScope(Dispatchers.Main).launch {
                        ...
                        when (btn) {
                            binding.btnStyleSimple -> startOrder(dinnerType, SIMPLE)
                            binding.btnStyleGrand -> startOrder(dinnerType, GRAND)
                            binding.btnStyleDeluxe -> startOrder(dinnerType, DELUXE)
                        }
                        cancel()
                    }
                }
    ...
    private fun startOrder(dinnerType: Int, styleType: Int) {
        ...
        intent.putExtra(StyleActivity.STYLE_TYPE, styleType)
